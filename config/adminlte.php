        ...
        'JqueryUI' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/vendor/jquery-ui-1.12.1/jquery-ui.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/vendor/jquery-ui-1.12.1/jquery.ui.touch-punch.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '/vendor/jquery-ui-1.12.1/jquery-ui.min.css',
                ],
            ],
        ],
    ],
